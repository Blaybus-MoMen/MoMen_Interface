package com.blaybus.core.handler;

import com.blaybus.core.dto.response.ApiResponse;
import com.blaybus.core.error.dto.ErrorResponse;
import com.blaybus.core.error.enums.ErrorCode;
import com.blaybus.core.exception.BusinessException;
import com.blaybus.core.exception.ResourceNotFoundException;
import com.blaybus.core.jenkins.exception.JenkinsBuildException;
import com.blaybus.core.jenkins.exception.JenkinsConnectionException;
import com.blaybus.core.jenkins.exception.JenkinsException;
import com.blaybus.core.jenkins.exception.JenkinsJobNotFoundException;
...
public class GlobalExceptionHandler {
     ...
     * 커스텀 인증 예외 처리
     */
    @ExceptionHandler(com.blaybus.core.exception.AuthenticationException.class)
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAuthenticationException(com.blaybus.core.exception.AuthenticationException e,
