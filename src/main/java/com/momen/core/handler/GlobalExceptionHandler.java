package com.momen.core.handler;

import com.momen.core.dto.response.ApiResponse;
import com.momen.core.error.dto.ErrorResponse;
import com.momen.core.error.enums.ErrorCode;
import com.momen.core.exception.BusinessException;
import com.momen.core.exception.ResourceNotFoundException;
import com.momen.core.jenkins.exception.JenkinsBuildException;
import com.momen.core.jenkins.exception.JenkinsConnectionException;
...
public class GlobalExceptionHandler {
     ...
     * 커스텀 인증 예외 처리
     */
    @ExceptionHandler(com.momen.core.exception.AuthenticationException.class)
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAuthenticationException(com.momen.core.exception.AuthenticationException e,
