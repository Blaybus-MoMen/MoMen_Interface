...
SET @pw = '$2a$10$vRZtvvQ2AxIoqIhpH2YIpu9O7LtzndGqx492TyWVPS67l.lln/qou';
SET @now = NOW();
...
INSERT INTO tbl_user (LOGIN_ID, EMAIL, PASSWORD_HASH, NAME, PHONE, ROLE, IS_ACTIVE, EMAIL_VERIFIED, EMAIL_VERIFIED_AT, CREATE_DT, UPDATE_DT) VALUES
-- Mentors
('mentor01', 'mentor01@test.com', @pw, '김영수', '010-1111-0001', 'MENTOR', 1, 1, @now, @now, @now),
('mentor02', 'mentor02@test.com', @pw, '이지현', '010-1111-0002', 'MENTOR', 1, 1, @now, @now, @now),
('mentor03', 'mentor03@test.com', @pw, '박준호', '010-1111-0003', 'MENTOR', 1, 1, @now, @now, @now),
-- Mentees (mentor01 담당)
('mentee01', 'mentee01@test.com', @pw, '최민서', '010-2222-0001', 'MENTEE', 1, 1, @now, @now, @now),
('mentee02', 'mentee02@test.com', @pw, '정하윤', '010-2222-0002', 'MENTEE', 1, 1, @now, @now, @now),
-- Mentees (mentor02 담당)
('mentee03', 'mentee03@test.com', @pw, '한서준', '010-2222-0003', 'MENTEE', 1, 1, @now, @now, @now),
('mentee04', 'mentee04@test.com', @pw, '윤도현', '010-2222-0004', 'MENTEE', 1, 1, @now, @now, @now),
-- Mentees (mentor03 담당)
('mentee05', 'mentee05@test.com', @pw, '강예린', '010-2222-0005', 'MENTEE', 1, 1, @now, @now, @now),
('mentee06', 'mentee06@test.com', @pw, '송지우', '010-2222-0006', 'MENTEE', 1, 1, @now, @now, @now);

-- ============================================================
-- Mentors
-- ============================================================

INSERT INTO mentors (user_id, intro, CREATE_DT, UPDATE_DT) VALUES
...
INSERT INTO mentees (user_id, mentor_id, grade, cheer_message, CREATE_DT, UPDATE_DT) VALUES
...
INSERT INTO mentee_subjects (mentee_id, subject) VALUES
...
INSERT INTO mentee_cards (mentee_id, card) VALUES
...
-- Summary
-- ============================================================
-- | Account  | Password   | Name   | Grade | Mentor   | Subjects         | Cards                              |
-- |----------|------------|--------|-------|----------|------------------|------------------------------------|
-- | mentor01 | test1234!  | 김영수 |       |          |                  |                                    |
-- | mentor02 | test1234!  | 이지현 |       |          |                  |                                    |
-- | mentor03 | test1234!  | 박준호 |       |          |                  |                                    |
-- | mentee01 | test1234!  | 최민서 | 고2   | 김영수   | MATH, ENGLISH    | 아침형 인간, 꼼꼼함, 만점목표      |
-- | mentee02 | test1234!  | 정하윤 | 고3   | 김영수   | KOREAN,MATH,ENG  | 끈기있는, 이해 중심, 인서울 목표    |
-- | mentee03 | test1234!  | 한서준 | 고1   | 이지현   | KOREAN, ENGLISH  | 질문 많음, 기초부터, 슬로우 스타터  |
-- | mentee04 | test1234!  | 윤도현 | 고2   | 이지현   | KOREAN, MATH     | 벼락치기형, 집중력 갑, 암기형      |
-- | mentee05 | test1234!  | 강예린 | 고3   | 박준호   | MATH, KOREAN     | 팩폭 환영, 전교1등도전, 집중력부족  |
-- | mentee06 | test1234!  | 송지우 | 고1   | 박준호   | ENGLISH, MATH    | 유리 멘탈, 내신 올킬, 수포자 탈출  |
-- ============================================================